...
ACP_BRIDGE_PKG="${ACP_BRIDGE_PKG:-@zhengqilin/aamp-acp-bridge@0.1.29-dev.1}"
FEISHU_BRIDGE_PKG="${FEISHU_BRIDGE_PKG:-@zhengqilin/aamp-feishu-bridge@0.1.52-dev.6}"
...
AAMP_TASK_AGENT_VERSION="0.1.1-dev.8"
